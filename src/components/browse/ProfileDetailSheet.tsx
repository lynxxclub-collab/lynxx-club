          ...
          <div className="sticky top-0 z-20 w-full aspect-[4/5] bg-card relative shrink-0">
            ...
            <div className="absolute top-4 left-4 right-4 flex justify-between items-start z-30">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="bg-[#1a1a20] border-white/10 text-foreground"
                >
                  <DropdownMenuItem
            ...
            {(profile.interests?.length || profile.hobbies?.length) ? (
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {[...(profile.interests || []), ...(profile.hobbies || [])].map(
                    (item, index) => (
                      <span
                        key={index}
                ...
                <Tabs defaultValue="video" className="w-full">
                  ...
                  <TabsContent value="video" className="space-y-2 mt-3">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <RateCard
                        duration="60min"
                        rate={profile.video_60min_rate}
                        icon={Video}
                      />
                      {profile.video_90min_rate && (
                        <RateCard
                          duration="90min"
                          rate={profile.video_90min_rate}
                          icon={Video}
                        />
                      )}
                    </div>
                  ...
                  <TabsContent value="audio" className="space-y-2 mt-3">
                    <div className="grid grid-cols-2 gap-2">
                      {profile.video_15min_rate && (
                        <RateCard
                          duration="15min"
                          rate={deriveAudioRate(profile.video_15min_rate)}
                          icon={Phone}
                        />
                      )}
                      <RateCard
                      ...
                      <RateCard
                        duration="60min"
                        rate={deriveAudioRate(profile.video_60min_rate)}
                        icon={Phone}
                      />
                      {profile.video_90min_rate && (
                        <RateCard
                          duration="90min"
                          rate={deriveAudioRate(profile.video_90min_rate)}
                          icon={Phone}
                        />
                      )}
                    </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[#0a0a0f] via-[#0a0a0f] to-transparent z-30 border-t border-white/5">
            {isEarnerViewing ? (
              ...
              <Button
                ...
                className="w-full h-12 bg-gradient-to-r from-rose-600 to-purple-600 hover:from-rose-500 hover:to-purple-500 text-white text-base font-semibold rounded-xl shadow-lg shadow-rose-900/20 border-0"
              >
