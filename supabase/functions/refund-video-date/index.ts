diff --git a/functions/refund-video-date/index.ts b/functions/refund-video-date/index.ts
--- a/functions/refund-video-date/index.ts
+++ b/functions/refund-video-date/index.ts
@@ -1,92 +1,39 @@
